    ...
    ) -> GResult<()> {
        {
            ...
            match pmode {
                ...
                ConstantOffset(r) => {
                    ...
                    let new_item =
                        OpCode(text.to_string(), ins, AddrModeParseType::Indexed(new_amode, indirect));
            ...
            MC6809::OpCode(text, ins, amode) => {
                match amode {
                    ...
                    AddrModeParseType::Indexed(pmode, indirect) => {
                        Self::size_indexed(sizer, asm, id,  *pmode, *indirect, text, ins)?;
                    }
