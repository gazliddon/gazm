...
macro_rules! op_table {
    ($op:expr, $fail:block) => {
        match $op {
            0x00 =>  handle_op!(Direct, neg, 0),
            0x03 =>  handle_op!(Direct, com, 0),
            0x04 =>  handle_op!(Direct, lsr, 0),
            0x06 =>  handle_op!(Direct, ror, 0),
            0x07 =>  handle_op!(Direct, asr, 0),
            0x08 =>  handle_op!(Direct, lsl_asl, 0),
            0x09 =>  handle_op!(Direct, rol, 0),
            0x0a =>  handle_op!(Direct, dec, 0),
            0x0c =>  handle_op!(Direct, inc, 0),
            0x0d =>  handle_op!(Direct, tst, 0),
            0x0e =>  handle_op!(Direct, jmp, 0),
            0x0f =>  handle_op!(Direct, clr, 0),
            0x12 =>  handle_op!(Inherent, nop, 0),
            0x13 =>  handle_op!(Inherent, sync, 0),
            0x16 =>  handle_op!(Relative, lbra, 0),
            0x17 =>  handle_op!(Relative, lbsr, 0),
            0x19 =>  handle_op!(Inherent, daa, 0),
            0x1a =>  handle_op!(Immediate8, orcc, 0),
            0x1c =>  handle_op!(Immediate8, andcc, 0),
            0x1d =>  handle_op!(Inherent, sex, 0),
            0x1e =>  handle_op!(Inherent, exg, 0),
            0x1f =>  handle_op!(Inherent, tfr, 0),
            0x20 =>  handle_op!(Relative, bra, 0),
            0x21 =>  handle_op!(Relative, brn, 0),
            0x22 =>  handle_op!(Relative, bhi, 0),
            0x23 =>  handle_op!(Relative, bls, 0),
            0x24 =>  handle_op!(Relative, bhs_bcc, 0),
            0x25 =>  handle_op!(Relative, blo_bcs, 0),
            0x26 =>  handle_op!(Relative, bne, 0),
            0x27 =>  handle_op!(Relative, beq, 0),
            0x28 =>  handle_op!(Relative, bvc, 0),
            0x29 =>  handle_op!(Relative, bvs, 0),
            0x2a =>  handle_op!(Relative, bpl, 0),
            0x2b =>  handle_op!(Relative, bmi, 0),
            0x2c =>  handle_op!(Relative, bge, 0),
            0x2d =>  handle_op!(Relative, blt, 0),
            0x2e =>  handle_op!(Relative, bgt, 0),
            0x2f =>  handle_op!(Relative, ble, 0),
            0x30 =>  handle_op!(Indexed, leax, 0),
            0x31 =>  handle_op!(Indexed, leay, 0),
            0x32 =>  handle_op!(Indexed, leas, 0),
            0x33 =>  handle_op!(Indexed, leau, 0),
            0x34 =>  handle_op!(Inherent, pshs, 0),
            0x35 =>  handle_op!(Inherent, puls, 0),
            0x36 =>  handle_op!(Inherent, pshu, 0),
            0x37 =>  handle_op!(Inherent, pulu, 0),
            0x39 =>  handle_op!(Inherent, rts, 0),
            0x3a =>  handle_op!(Inherent, abx, 0),
            0x3b =>  handle_op!(Inherent, rti, 0),
            0x3c =>  handle_op!(Inherent, cwai, 0),
            0x3d =>  handle_op!(Inherent, mul, 0),
            0x3f =>  handle_op!(Inherent, swi, 0),
            0x40 =>  handle_op!(Inherent, nega, 0),
            0x43 =>  handle_op!(Inherent, coma, 0),
            0x44 =>  handle_op!(Inherent, lsra, 0),
            0x46 =>  handle_op!(Inherent, rora, 0),
            0x47 =>  handle_op!(Inherent, asra, 0),
            0x48 =>  handle_op!(Inherent, lsla_asla, 0),
            0x49 =>  handle_op!(Inherent, rola, 0),
            0x4a =>  handle_op!(Inherent, deca, 0),
            0x4c =>  handle_op!(Inherent, inca, 0),
            0x4d =>  handle_op!(Inherent, tsta, 0),
            0x4f =>  handle_op!(Inherent, clra, 0),
            0x50 =>  handle_op!(Inherent, negb, 0),
            0x53 =>  handle_op!(Inherent, comb, 0),
            0x54 =>  handle_op!(Inherent, lsrb, 0),
            0x56 =>  handle_op!(Inherent, rorb, 0),
            0x57 =>  handle_op!(Inherent, asrb, 0),
            0x58 =>  handle_op!(Inherent, lslb_aslb, 0),
            0x59 =>  handle_op!(Inherent, rolb, 0),
            0x5a =>  handle_op!(Inherent, decb, 0),
            0x5c =>  handle_op!(Inherent, incb, 0),
            0x5d =>  handle_op!(Inherent, tstb, 0),
            0x5f =>  handle_op!(Inherent, clrb, 0),
            0x60 =>  handle_op!(Indexed, neg, 0),
            0x63 =>  handle_op!(Indexed, com, 0),
            0x64 =>  handle_op!(Indexed, lsr, 0),
            0x66 =>  handle_op!(Indexed, ror, 0),
            0x67 =>  handle_op!(Indexed, asr, 0),
            0x68 =>  handle_op!(Indexed, lsl_asl, 0),
            0x69 =>  handle_op!(Indexed, rol, 0),
            0x6a =>  handle_op!(Indexed, dec, 0),
            0x6c =>  handle_op!(Indexed, inc, 0),
            0x6d =>  handle_op!(Indexed, tst, 0),
            0x6e =>  handle_op!(Indexed, jmp, 0),
            0x6f =>  handle_op!(Indexed, clr, 0),
            0x70 =>  handle_op!(Extended, neg, 0),
            0x73 =>  handle_op!(Extended, com, 0),
            0x74 =>  handle_op!(Extended, lsr, 0),
            0x76 =>  handle_op!(Extended, ror, 0),
            0x77 =>  handle_op!(Extended, asr, 0),
            0x78 =>  handle_op!(Extended, lsl_asl, 0),
            0x79 =>  handle_op!(Extended, rol, 0),
            0x7a =>  handle_op!(Extended, dec, 0),
            0x7c =>  handle_op!(Extended, inc, 0),
            0x7d =>  handle_op!(Extended, tst, 0),
            0x7e =>  handle_op!(Extended, jmp, 0),
            0x7f =>  handle_op!(Extended, clr, 0),
            0x80 =>  handle_op!(Immediate8, suba, 0),
            0x81 =>  handle_op!(Immediate8, cmpa, 0),
            0x82 =>  handle_op!(Immediate8, sbca, 0),
            0x83 =>  handle_op!(Immediate16, subd, 0),
            0x84 =>  handle_op!(Immediate8, anda, 0),
            0x85 =>  handle_op!(Immediate8, bita, 0),
            0x86 =>  handle_op!(Immediate8, lda, 0),
            0x88 =>  handle_op!(Immediate8, eora, 0),
            0x89 =>  handle_op!(Immediate8, adca, 0),
            0x8a =>  handle_op!(Immediate8, ora, 0),
            0x8b =>  handle_op!(Immediate8, adda, 0),
            0x8c =>  handle_op!(Immediate16, cmpx, 0),
            0x8d =>  handle_op!(Relative, bsr, 0),
            0x8e =>  handle_op!(Immediate16, ldx, 0),
            0x90 =>  handle_op!(Direct, suba, 0),
            0x91 =>  handle_op!(Direct, cmpa, 0),
            0x92 =>  handle_op!(Direct, sbca, 0),
            0x93 =>  handle_op!(Direct, subd, 0),
            0x94 =>  handle_op!(Direct, anda, 0),
            0x95 =>  handle_op!(Direct, bita, 0),
            0x96 =>  handle_op!(Direct, lda, 0),
            0x97 =>  handle_op!(Direct, sta, 0),
            0x98 =>  handle_op!(Direct, eora, 0),
            0x99 =>  handle_op!(Direct, adca, 0),
            0x9a =>  handle_op!(Direct, ora, 0),
            0x9b =>  handle_op!(Direct, adda, 0),
            0x9c =>  handle_op!(Direct, cmpx, 0),
            0x9d =>  handle_op!(Direct, jsr, 0),
            0x9e =>  handle_op!(Direct, ldx, 0),
            0x9f =>  handle_op!(Direct, stx, 0),
            0xa0 =>  handle_op!(Indexed, suba, 0),
            0xa1 =>  handle_op!(Indexed, cmpa, 0),
            0xa2 =>  handle_op!(Indexed, sbca, 0),
            0xa3 =>  handle_op!(Indexed, subd, 0),
            0xa4 =>  handle_op!(Indexed, anda, 0),
            0xa5 =>  handle_op!(Indexed, bita, 0),
            0xa6 =>  handle_op!(Indexed, lda, 0),
            0xa7 =>  handle_op!(Indexed, sta, 0),
            0xa8 =>  handle_op!(Indexed, eora, 0),
            0xa9 =>  handle_op!(Indexed, adca, 0),
            0xaa =>  handle_op!(Indexed, ora, 0),
            0xab =>  handle_op!(Indexed, adda, 0),
            0xac =>  handle_op!(Indexed, cmpx, 0),
            0xad =>  handle_op!(Indexed, jsr, 0),
            0xae =>  handle_op!(Indexed, ldx, 0),
            0xaf =>  handle_op!(Indexed, stx, 0),
            0xb0 =>  handle_op!(Extended, suba, 0),
            0xb1 =>  handle_op!(Extended, cmpa, 0),
            0xb2 =>  handle_op!(Extended, sbca, 0),
            0xb3 =>  handle_op!(Extended, subd, 0),
            0xb4 =>  handle_op!(Extended, anda, 0),
            0xb5 =>  handle_op!(Extended, bita, 0),
            0xb6 =>  handle_op!(Extended, lda, 0),
            0xb7 =>  handle_op!(Extended, sta, 0),
            0xb8 =>  handle_op!(Extended, eora, 0),
            0xb9 =>  handle_op!(Extended, adca, 0),
            0xba =>  handle_op!(Extended, ora, 0),
            0xbb =>  handle_op!(Extended, adda, 0),
            0xbc =>  handle_op!(Extended, cmpx, 0),
            0xbd =>  handle_op!(Extended, jsr, 0),
            0xbe =>  handle_op!(Extended, ldx, 0),
            0xbf =>  handle_op!(Extended, stx, 0),
            0xc0 =>  handle_op!(Immediate8, subb, 0),
            0xc1 =>  handle_op!(Immediate8, cmpb, 0),
            0xc2 =>  handle_op!(Immediate8, sbcb, 0),
            0xc3 =>  handle_op!(Immediate16, addd, 0),
            0xc4 =>  handle_op!(Immediate8, andb, 0),
            0xc5 =>  handle_op!(Immediate8, bitb, 0),
            0xc6 =>  handle_op!(Immediate8, ldb, 0),
            0xc8 =>  handle_op!(Immediate8, eorb, 0),
            0xc9 =>  handle_op!(Immediate8, adcb, 0),
            0xca =>  handle_op!(Immediate8, orb, 0),
            0xcb =>  handle_op!(Immediate8, addb, 0),
            0xcc =>  handle_op!(Immediate16, ldd, 0),
            0xce =>  handle_op!(Immediate16, ldu, 0),
            0xd0 =>  handle_op!(Direct, subb, 0),
            0xd1 =>  handle_op!(Direct, cmpb, 0),
            0xd2 =>  handle_op!(Direct, sbcb, 0),
            0xd3 =>  handle_op!(Direct, addd, 0),
            0xd4 =>  handle_op!(Direct, andb, 0),
            0xd5 =>  handle_op!(Direct, bitb, 0),
            0xd6 =>  handle_op!(Direct, ldb, 0),
            0xd7 =>  handle_op!(Direct, stb, 0),
            0xd8 =>  handle_op!(Direct, eorb, 0),
            0xd9 =>  handle_op!(Direct, adcb, 0),
            0xda =>  handle_op!(Direct, orb, 0),
            0xdb =>  handle_op!(Direct, addb, 0),
            0xdc =>  handle_op!(Direct, ldd, 0),
            0xdd =>  handle_op!(Direct, std, 0),
            0xde =>  handle_op!(Direct, ldu, 0),
            0xdf =>  handle_op!(Direct, stu, 0),
            0xe0 =>  handle_op!(Indexed, subb, 0),
            0xe1 =>  handle_op!(Indexed, cmpb, 0),
            0xe2 =>  handle_op!(Indexed, sbcb, 0),
            0xe3 =>  handle_op!(Indexed, addd, 0),
            0xe4 =>  handle_op!(Indexed, andb, 0),
            0xe5 =>  handle_op!(Indexed, bitb, 0),
            0xe6 =>  handle_op!(Indexed, ldb, 0),
            0xe7 =>  handle_op!(Indexed, stb, 0),
            0xe8 =>  handle_op!(Indexed, eorb, 0),
            0xe9 =>  handle_op!(Indexed, adcb, 0),
            0xea =>  handle_op!(Indexed, orb, 0),
            0xeb =>  handle_op!(Indexed, addb, 0),
            0xec =>  handle_op!(Indexed, ldd, 0),
            0xed =>  handle_op!(Indexed, std, 0),
            0xee =>  handle_op!(Indexed, ldu, 0),
            0xef =>  handle_op!(Indexed, stu, 0),
            0xf0 =>  handle_op!(Extended, subb, 0),
            0xf1 =>  handle_op!(Extended, cmpb, 0),
            0xf2 =>  handle_op!(Extended, sbcb, 0),
            0xf3 =>  handle_op!(Extended, addd, 0),
            0xf4 =>  handle_op!(Extended, andb, 0),
            0xf5 =>  handle_op!(Extended, bitb, 0),
            0xf6 =>  handle_op!(Extended, ldb, 0),
            0xf7 =>  handle_op!(Extended, stb, 0),
            0xf8 =>  handle_op!(Extended, eorb, 0),
            0xf9 =>  handle_op!(Extended, adcb, 0),
            0xfa =>  handle_op!(Extended, orb, 0),
            0xfb =>  handle_op!(Extended, addb, 0),
            0xfc =>  handle_op!(Extended, ldd, 0),
            0xfd =>  handle_op!(Extended, std, 0),
            0xfe =>  handle_op!(Extended, ldu, 0),
            0xff =>  handle_op!(Extended, stu, 0),
            0x113f => handle_op!(Inherent,  swi3, 0),
            0x1183 => handle_op!(Immediate16,  cmpu, 0),
            0x118c => handle_op!(Immediate16,  cmps, 0),
            0x1193 => handle_op!(Direct, cmpu, 0),
            0x119c => handle_op!(Direct, cmps, 0),
            0x11a3 => handle_op!(Indexed, cmpu, 0),
            0x11ac => handle_op!(Indexed, cmps, 0),
            0x11b3 => handle_op!(Extended, cmpu, 0),
            0x11bc => handle_op!(Extended, cmps, 0),
            0x1021 => handle_op!(Relative, lbrn, 0),
            0x1022 =>  handle_op!(Relative, lbhi, 0),
            0x1023 =>  handle_op!(Relative, lbls, 0),
            0x1024 =>  handle_op!(Relative, lbhs_lbcc, 0),
            0x1025 =>  handle_op!(Relative, lblo_lbcs, 0),
            0x1026 =>  handle_op!(Relative, lbne, 0),
            0x1027 =>  handle_op!(Relative, lbeq, 0),
            0x1028 =>  handle_op!(Relative, lbvc, 0),
            0x1029 =>  handle_op!(Relative, lbvs, 0),
            0x102a =>  handle_op!(Relative, lbpl, 0),
            0x102b =>  handle_op!(Relative, lbmi, 0),
            0x102c =>  handle_op!(Relative, lbge, 0),
            0x102d =>  handle_op!(Relative, lblt, 0),
            0x102e =>  handle_op!(Relative, lbgt, 0),
            0x102f =>  handle_op!(Relative, lble, 0),
            0x103f =>  handle_op!(Inherent, swi2, 0),
            0x1083 =>  handle_op!(Immediate16, cmpd, 0),
            0x108c =>  handle_op!(Immediate16, cmpy, 0),
            0x108e =>  handle_op!(Immediate16, ldy, 0),
            0x1093 =>  handle_op!(Direct, cmpd, 0),
            0x109c =>  handle_op!(Direct, cmpy, 0),
            0x109e =>  handle_op!(Direct, ldy, 0),
            0x109f =>  handle_op!(Direct, sty, 0),
            0x10a3 =>  handle_op!(Indexed, cmpd, 0),
            0x10ac =>  handle_op!(Indexed, cmpy, 0),
            0x10ae =>  handle_op!(Indexed, ldy, 0),
            0x10af =>  handle_op!(Indexed, sty, 0),
            0x10b3 =>  handle_op!(Extended, cmpd, 0),
            0x10bc =>  handle_op!(Extended, cmpy, 0),
            0x10be =>  handle_op!(Extended, ldy, 0),
            0x10bf =>  handle_op!(Extended, sty, 0),
            0x10ce =>  handle_op!(Immediate16, lds, 0),
            0x10de =>  handle_op!(Direct, lds, 0),
            0x10df =>  handle_op!(Direct, sts, 0),
            0x10ee =>  handle_op!(Indexed, lds, 0),
            0x10ef =>  handle_op!(Indexed, sts, 0),
            0x10fe =>  handle_op!(Extended, lds, 0),
            0x10ff =>  handle_op!(Extended, sts, 0),
            _ => $fail
        }
    }
}
