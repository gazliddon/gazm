...
macro_rules! op_table {
    ($op:expr, $fail:block) => {
        match $op {
            ...
            0x1a =>  handle_op!(Immediate, orcc, 0),
            0x1c =>  handle_op!(Immediate, andcc, 0),
            ...
            0x3e =>  handle_op!(Inherent, reset, 0),
            ...
            0x80 =>  handle_op!(Immediate, suba, 0),
            0x81 =>  handle_op!(Immediate, cmpa, 0),
            0x82 =>  handle_op!(Immediate, sbca, 0),
            0x83 =>  handle_op!(Immediate, subd, 0),
            0x84 =>  handle_op!(Immediate, anda, 0),
            0x85 =>  handle_op!(Immediate, bita, 0),
            0x86 =>  handle_op!(Immediate, lda, 0),
            0x88 =>  handle_op!(Immediate, eora, 0),
            0x89 =>  handle_op!(Immediate, adca, 0),
            0x8a =>  handle_op!(Immediate, ora, 0),
            0x8b =>  handle_op!(Immediate, adda, 0),
            0x8c =>  handle_op!(Immediate, cmpx, 0),
            0x8d =>  handle_op!(Relative, bsr, 0),
            0x8e =>  handle_op!(Immediate, ldx, 0),
            ...
            0xc0 =>  handle_op!(Immediate, subb, 0),
            0xc1 =>  handle_op!(Immediate, cmpb, 0),
            0xc2 =>  handle_op!(Immediate, sbcb, 0),
            0xc3 =>  handle_op!(Immediate, addd, 0),
            0xc4 =>  handle_op!(Immediate, andb, 0),
            0xc5 =>  handle_op!(Immediate, bitb, 0),
            0xc6 =>  handle_op!(Immediate, ldb, 0),
            0xc8 =>  handle_op!(Immediate, eorb, 0),
            0xc9 =>  handle_op!(Immediate, adcb, 0),
            0xca =>  handle_op!(Immediate, orb, 0),
            0xcb =>  handle_op!(Immediate, addb, 0),
            0xcc =>  handle_op!(Immediate, ldd, 0),
            0xce =>  handle_op!(Immediate, ldu, 0),
            ...
            0x1183 => handle_op!(Immediate,  cmpu, 0),
            0x118c => handle_op!(Immediate,  cmps, 0),
            ...
            0x1083 =>  handle_op!(Immediate, cmpd, 0),
            0x108c =>  handle_op!(Immediate, cmpy, 0),
            0x108e =>  handle_op!(Immediate, ldy, 0),
            ...
            0x10ce =>  handle_op!(Immediate, lds, 0),
